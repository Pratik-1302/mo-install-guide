Microsoft SQL Server 2022 on Rocky Linux 9. Microsoft does **not** officially list AlmaLinux in its supported matrix, but AlmaLinux is binary-compatible with RHEL 9 and the RHEL 9 packages install and run cleanly in practice. Treat this combination as partial support, not production-blessed.
...
### 2.2 Add the Microsoft repository (using the RHEL 9 repo)
