Microsoft SQL Server 2022 on Rocky Linux 9. Microsoft does **not** officially list Rocky Linux in its supported matrix, but Rocky is binary-compatible with RHEL 9 and the RHEL 9 packages install and run cleanly in practice. Treat this combination as partial support, not production-blessed.
