RabbitMQ and Erlang on Alpine 3.21. Both are in the community repository.
...
You should see a line like `http://dl-cdn.alpinelinux.org/alpine/v3.21/community`. If not, add it and `apk update`.
...
> **Version note.** Alpine 3.21's `rabbitmq-server` package is version 3.13.x as of this writing. The major version (3.13) matches what the source guide specifies; patch versions may differ.
