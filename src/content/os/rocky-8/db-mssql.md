Microsoft SQL Server 2022 on RHEL 8. Microsoft does **not** officially list Rocky Linux 8 in its supported matrix, but Rocky is binary-compatible with RHEL 8 and the RHEL 8 packages install and run cleanly in practice. Treat this combination as partial support. The IDP wiring (JDBC driver placement) is **derived** from the Oracle source flow.
