MySQL 8.4 LTS on Ubuntu 22.04. These steps are **derived** from the MySQL APT repo install path combined with the JDBC driver placement convention from the source Oracle flow; review before production.
