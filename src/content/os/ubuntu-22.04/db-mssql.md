Microsoft SQL Server 2022 on Ubuntu 22.04. Microsoft officially supports MSSQL on Ubuntu 22.04. The IDP wiring is **derived** from the Oracle source flow (driver placement) plus the Microsoft `mssql-server` install instructions.
