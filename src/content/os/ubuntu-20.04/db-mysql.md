MySQL 8.4 LTS on Ubuntu 20.04. These steps are **derived** from the MySQL APT repo install path combined with the JDBC driver placement convention from the source Oracle flow; review before production.
...
cd /tmp
sudo wget https://dev.mysql.com/get/Downloads/Connector-J/mysql-connector-j_8.4.0-1ubuntu22.04_all.deb
