PostgreSQL 16 on Ubuntu 20.04 (focal). Ubuntu's universe ships PostgreSQL 14, which is too old; add the official PGDG apt repository to get 16. The installer ships the PostgreSQL JDBC driver, so no manual driver placement is needed.
