Microsoft SQL Server 2022 on RHEL 8. Microsoft officially supports MSSQL on RHEL 8. The IDP wiring (JDBC driver placement) is **derived** from the Oracle source flow.
